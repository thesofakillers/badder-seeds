...
if __name__ == "__main__":
    ...
    embed_dict = read_wordembedding("./data/w2v_gnews_small.txt")
    ...
    # do pca
    pca_ordered = metrics.do_pca(seed_female, seed_male, embed_dict)
    pca_shuffled = metrics.do_pca(seed1_shuffled, seed2_shuffled, embed_dict)
