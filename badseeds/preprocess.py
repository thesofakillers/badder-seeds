...
if __name__ == "__main__":
	...
	with open('../data/nytimes_news_articles.txt', 'r') as f:
		...
		pickle.dump(all_sentences, open('../data/processed/nytimes_news_articles.pkl', 'wb'))
	...
	with open('../data/goodreads_reviews_dedup.json', 'r') as f:
		...
		pickle.dump(all_sentences, open('../data/processed/goodreads_reviews_dedup.pkl', 'wb'))
